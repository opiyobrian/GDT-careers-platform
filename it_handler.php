...
if(isset($_POST["apply"])){
    ...
    $insertQuery = "INSERT INTO `it`(`id`, `name`, `email`, `phone`, `gender`, `country`, `academic`, `field`, `grade`, `cv`) VALUES (null,'$name','$email','$phone','$gender','$country','$academic','$field','$grade','$cv')";
