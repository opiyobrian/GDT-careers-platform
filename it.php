...
<head>
    ...
    <style>
        ...
        .kibet {
            width: 100%;
            background: url(assets/images/job.jpg);
...
<body class='kibet'>
    ...
    <form method="POST" action="it_handler.php">
        <div class="row">
                ...
                <input type="file" id="" class="form-control form-input form-style-base" name="cv" accept ="application/pdf ">
