...
<div class='ben'>
    ...
    <form action="password_handler.php" class="was-validated" method="POST">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <input class='btn btn-primary' type="submit" name="update" value="Reset password">&nbsp &nbsp &nbsp &nbsp
                <a input class='btn btn-primary' href="login.php">Back</a>
            </div>
            <div class="col-md-4"></div>
        </div>
